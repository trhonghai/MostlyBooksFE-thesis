...
function Checkout() {
  ...
  const fetchAddress = async () => {
    ...
    setAddressChecked(
      result.find((item) => item.defaultForShopping === true) || ""
    );
  ...
  return (
    <section class="pt-2 justify-center bg-gray-100">
      <div className="container flex md:w-4/5 mx-auto px-4">
        <div className="container md:w-2/3 mx-auto px-4 bg-white mb-4 rounded-lg">
          <div class="container w-full mx-auto px-4 bg-white rounded-lg">
        ...
        <div class="container ml-4 md:w-1/3 mx-auto px-4  rounded-lg">
