        ...
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            ...
            <p class="text-justify">
              ...
              tất cả Hệ Thống MostlyBooks trên toàn quốc.
            </p>
          </div>

          <div class="px-4 my-4 w-full sm:w-auto text-justify">
            <div>
              <h2 class="inline-block font-bold text-xl pb-4 mb-4 border-b-4 border-[#FFD16B]">
                DỊCH VỤ
              </h2>
            </div>
            <ul class="leading-8 ">
              ...
              <li>
                <a href="#" class="hover:text-blue-400">
                  Chính sách bảo mặt thông tin cá nhân
                </a>
              </li>
              <li>
                <a href="#" class="hover:text-blue-400">
                  Chính sách bảo mặt thông tin thanh toán
                </a>
              </li>
              <li>
                <a href="#" class="hover:text-blue-400">
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5 text-justify">
            <div>
              <h2 class="inline-block font-bold text-xl pb-4 mb-4 border-b-4 border-[#FFD16B]">
                Liên hệ qua
              </h2>
            ...
            <a>
              <img
                className="w-28 mt-4 h-28 object-cover"
                src={images.Paypal}
                alt="logo"
              />
            </a>
